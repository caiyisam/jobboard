...
dhtmlXForm.prototype.items.checkbox = {
	...
	doAddLabel: function(item, data) {
		...
		t.innerHTML = "<div class='dhxform_label_nav_link' "+
				...
				"onkeyup='e=event||window.arguments[0];this.parentNode.parentNode._doOnKeyUpDown(\"onKeyUp\",e);' "+
				"onkeydown='e=event||window.arguments[0];this.parentNode.parentNode._doOnKeyUpDown(\"onKeyDown\",e);' "+
...
dhtmlXForm.prototype.items.radio = {
	...
	render: function(item, data, uid) {
		...
		item._doOnKeyUpDown = function(evName, evObj, inp) {
			this.callEvent(evName, [this.childNodes[this._ll?0:1].childNodes[0], e, this._group, this._value]);
		}
